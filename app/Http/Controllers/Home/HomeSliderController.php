...
class HomeSliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validateData = $request->validate([
            'title' => 'required|unique:home_sliders|max:50',
            ...
            'title.max' => 'slider title must not be more than 50 character',

            'content.required' => 'Please input slider content',
            'content.max' => 'slider content must not be more than 100 character',
